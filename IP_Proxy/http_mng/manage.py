...
class o:
    ...
    def __init__(self, url, headers, ip_proxy):
        if ip_proxy:
        ...
        try:
            self.response = requests.get(url, proxies=ip_proxy, headers=self.__send_headers)
    ...
    def get_html_content(self):
        if self.response is not None:
            self.__receive_html = self.response.text        #返回网页内容
    ...
    def get_receive_header(self):
        if self.response is not None:
            self.__receive_header = self.response.headers        #返回网页内容
...
if __name__ == "__main__":
    ...
    # o = o("http://httpbin.org/ip", False, ip_proxy={"https":"1.1.1:808"})
    o = o("http://2017.ip138.com/ic.asp", False, ip_proxy={"http":"115.29.163.82:808"})
    # o = o("http://2017.ip138.com/ic.asp", False, ip_proxy={"http":"115.29.163.82:808"})
