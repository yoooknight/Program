...
$local_url = Url::to(["newlist/index"]);
?>

<link href="css/style.css" rel="stylesheet">

<article class="blogs">
<h1 class="t_nav"><span>“慢生活”不是懒惰，放慢速度不是拖延时间，而是让我们在生活中寻找到平衡。</span><a href="<?php echo $index_url?>" class="n1">网站首页</a><a href="<?php echo $local_url?>" class="n2">慢生活</a></h1>
