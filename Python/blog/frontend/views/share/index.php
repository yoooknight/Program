...
$local_url = Url::to(["share/index"]);
?>

<link href="css/share.css" rel="stylesheet">

<article class="blogs">
    <h1 class="t_nav"><span>好咖啡要和朋友一起品尝，好“模板”也要和同样喜欢它的人一起分享。 </span><a href="<?php echo $index_url?>" class="n1">网站首页</a><a href="<?php echo $local_url?>" class="n2">模板分享</a></h1>
