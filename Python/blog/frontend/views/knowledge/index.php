...
$local_url = Url::to(["knowledge/index"]);
?>

<link href="css/learn.css" rel="stylesheet">

<article class="blogs">
    <h1 class="t_nav"><span>我们长路漫漫，只因学无止境。 </span><a href="<?php echo $index_url?>" class="n1">网站首页</a><a href="<?php echo $local_url?>" class="n2">学无止境</a></h1>
